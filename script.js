function calculateGauntlets() {
    ...
    var alThing = ((luck * 9) + (luck * 11)) / 10;
    var finalThingValue = alThing * trs;

    var alRuins = ((luck * 1000) + (luck * 1000)) / 1010;
    var finalRuinsValue = alRuins * trs;

    let bestGauntlet = "";
    let bestValue = Math.max(finalJackpotValue, finalGravValue, finalFleshValue, finalShaderValue, finalPoleValue, finalThingValue, finalRuinsValue);
    ...
    } else if (bestValue === finalThingValue) {
        bestGauntlet = "The Thing"
